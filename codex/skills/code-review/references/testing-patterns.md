...
> Vendored from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills/blob/7676817c12a1317454ae3898a0c5c1eacf5dd3d5/references/testing-patterns.md) at commit `7676817c12a1317454ae3898a0c5c1eacf5dd3d5` under the bundled MIT license.
...
Quick reference of JavaScript/TypeScript testing patterns using Jest, React Testing Library, Supertest, and Playwright. Arrange-Act-Assert, naming, mock discipline, and the anti-patterns generalize; the syntax and tooling do not. In another stack, follow the repository's own test framework and commands.
