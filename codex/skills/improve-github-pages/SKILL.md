...
This complete skill and its bundled resources are generated from `agent-plugins/skills/improve-github-pages/SKILL.md`. Manual changes in this directory will be overwritten the next time the generator runs. Edit the canonical skill instead.
