...
The GitHub workflow in `.github/workflows/regenerate-skills.yml` regenerates all skills after either a direct push or a pull request merge updates `master`, and commits generated updates when needed.
